...
requisitions_bp = Blueprint('requisitions', __name__, template_folder='templates')

@requisitions_bp.route('/section/requisitions')
def report_page():
    return render_template('sections/requisitions.html', requisitions=requisitions)

@requisitions_bp.route('/submit-requisitions', methods=['POST'])
def submit_requisitions():
